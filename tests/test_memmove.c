...
int main(int argc, char **argv)
{
	...
	result = ft_memmove(dst, src, 0);
	printf("Result: %s\n\n", result);
	printf("Testing with size 5...\n");
	result = ft_memmove(dst, src, 5);
	printf("Result: %s\n\n", result);
	printf("Testing with size 10...\n");
	result = ft_memmove(dst, src, 10);
	printf("Result: %s\n\n", result);
	printf("Testing with size 20...\n");
	result = ft_memmove(dst, src, 20);
	printf("Result: %s\n\n", result);
	printf("Testing with size 50...\n");
	result = ft_memmove(dst, src, 50);
	printf("Result: %s\n\n", result);
	printf("Testing with size 8 and reversed strings...\n");
	result = ft_memmove(src, dst, 8);
	printf("Result: %s\n\n", result);
	return (0);
}
